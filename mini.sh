...
if wget -q https://github.com/zenki2104/Mini-bot-md/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/zenki2104/Mini-bot-md\ncd Mini-bot-md\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1;35m"
git clone https://github.com/zenki2104/Mini-bot-md.git
...
menu_ayuda() {
    #printf "${v1}[${b}++${v1}]${v} Mini-bot-md${b}: "
	read opcion
	case $opcion in
            01|1)
