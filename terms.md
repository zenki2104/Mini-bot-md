...
> **Este repositorio, alojado originalmente en [GitHub](https://github.com/GataNina-Li/Mini-bot-md), incluye complementos que han sido creados bajo la propiedad exclusiva de este repositorio.**
...
Dentro del código, no se solicita ningún pago real ni compra, a excepción de la posibilidad de realizar una donación voluntaria a través de [**PayPal**](https://paypal.me/).<br /><br />
...
- [x] **1. AUTORIZADOS**<br>
> **Distribución autorizada del código solo con [permiso](https://www.atom.bio/).**
...
El servicio de hosting proporciona alojamiento para Bot en sus servidores, enfatizando que no vende el código de bot. Han leído y aceptado la política de bot, consolidando mejoras para la Comunidad bot y la comunidad de BoxMine.
</details>

<details>
<summary><b>Cafirexos</b></summary>

Como servicio de hosting especializado en alojamiento de Bots, ofrece una versión de bot con la aprobación de la misma, conforme a su disposición de aceptar la política de bot.
</details>

<details>
<summary><b>Vortexus Cloud</b></summary>

bot forma parte del catálogo de Vortexus Cloud, que ofrece alojamiento en la nube. Este servicio acepta la política de bot, fortaleciendo la disposición de trabajar de manera conjunta.
</details>
...
### Cuentas Oficiales
Las cuentas oficiales de WhatsApp están bajo el control del Staff bot. Se implementa una rutina de eliminación de mensajes cada 24 horas, y la database se borra con frecuencia para garantizar que no se acumulen datos de usuarios. El progreso en estas cuentas no se mantiene de manera inamovible. El Staff realiza vigilancia para mantener la cuenta activa y utilizar datos públicos que contribuyan a mejorar bot según las diversas situaciones de los usuarios con acceso a la cuenta oficial.
